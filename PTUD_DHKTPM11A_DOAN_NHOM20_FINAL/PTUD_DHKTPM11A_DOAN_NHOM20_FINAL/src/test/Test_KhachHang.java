			...
			do {
				...
				switch(chon) {
					...
					case 4:
						...
						int ma1 =sc.nextInt();
						if(xlKH.suaKhachHang(xlKH.timKhachHangTheoMa(ma1))) {
							sc.nextLine();
							System.out.println("nhap thong tin khach hang");
							System.out.println("ten nhan vien :");
							...
							KhachHang kh2=new KhachHang(ma1, tenkh1, cmndkh1, dckh1, gtkh1, sdtkh1);
					...
					case 5:
						...
						int ma3 =sc.nextInt();
						KhachHang kh4=xlKH.timKhachHangTheoMa(ma3);
						if(kh4!=null) {
