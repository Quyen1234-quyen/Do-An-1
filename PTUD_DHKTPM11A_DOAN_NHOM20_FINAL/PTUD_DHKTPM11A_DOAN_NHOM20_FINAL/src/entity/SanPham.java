...
//	@GeneratedValue(strategy=GenerationType.IDENTITY) 
	...
	public SanPham(int maSanPham, String tenSanPham, double giaSanPham, String xuatXuSanPham, int tonKhoSanPham) {
		super();
	...
	public SanPham(String tenSanPham, double giaSanPham, String xuatXuSanPham, int tonKhoSanPham) {
		super();
		this.tenSanPham = tenSanPham;
		this.giaSanPham = giaSanPham;
		this.xuatXuSanPham = xuatXuSanPham;
